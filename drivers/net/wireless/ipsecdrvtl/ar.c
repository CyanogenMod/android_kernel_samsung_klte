/*
   'src_compress_deflate_adler32.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Sun Nov 16 20:01:26 2014
*/
#include"cobf.h"
#ifdef _WIN32
...
bb194=bb367&0xffff ;bbd bb329=(bb367>>16 )&0xffff ;bbe bb3;bbm(bb40==0 )bb2
1L ;bb107(bb21>0 ){bb3=bb21<5552 ?bb21:5552 ;bb21-=bb3;bb107(bb3>=16 ){{
bb194+=bb40[0 ];bb329+=bb194;};{bb194+=bb40[0 +1 ];bb329+=bb194;};;{
bb194+=bb40[0 +2 ];bb329+=bb194;};{bb194+=bb40[0 +2 +1 ];bb329+=bb194;};;;
{bb194+=bb40[0 +4 ];bb329+=bb194;};{bb194+=bb40[0 +4 +1 ];bb329+=bb194;};;
{bb194+=bb40[0 +4 +2 ];bb329+=bb194;};{bb194+=bb40[0 +4 +2 +1 ];bb329+=bb194
;};;;;{bb194+=bb40[8 ];bb329+=bb194;};{bb194+=bb40[8 +1 ];bb329+=bb194;}
;;{bb194+=bb40[8 +2 ];bb329+=bb194;};{bb194+=bb40[8 +2 +1 ];bb329+=bb194;}
;;;{bb194+=bb40[8 +4 ];bb329+=bb194;};{bb194+=bb40[8 +4 +1 ];bb329+=bb194;
};;{bb194+=bb40[8 +4 +2 ];bb329+=bb194;};{bb194+=bb40[8 +4 +2 +1 ];bb329+=
bb194;};;;;;bb40+=16 ;bb3-=16 ;}bbm(bb3!=0 )bb574{bb194+= *bb40++;bb329
+=bb194;}bb107(--bb3);bb194%=65521L ;bb329%=65521L ;}bb2(bb329<<16 )|
bb194;}
