/*
   'src_nic_vpndbg.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Sun Nov 16 20:01:26 2014
*/
#include"cobf.h"
#ifdef _WIN32
...
bb141 bb1845(bb79 bb76,bb85 bb48);
#ifdef _WIN32
#ifdef bb311
#define bb1513 ( bb106)-1
#include"uncobf.h"
#include<stdarg.h>
#include<stdio.h>
#include"cobf.h"
...
#else
#ifdef bb311
#define bb2535 bb2442
#endif
#define bb1513 ( bb106)-1
#endif
bb41 bb82 bb1974(bbh bbb*bb2280,bbl bb40[32 ]){bb1 bb28=(bb1)bb2280;
bb1316(bb40,"\x25\x64\x2e\x25\x64\x2e\x25\x64\x2e\x25\x64",bb28[0 ],
bb28[1 ],bb28[2 ],bb28[3 ]);bb2 bb40;}bb41 bbd bb2426(bbh bbb*bb2280){
bb1 bb28=(bb1)bb2280;bb2 bb28[0 ]<<24 |bb28[1 ]<<16 |bb28[2 ]<<8 |bb28[3 ];}
bb41 bb82 bb2399(bbf bb2507[6 ],bbl bb40[32 ]){bbf*bb432=bb2507;bb1316(
bb40,"\x25\x30\x32\x58\x2d\x25\x30\x32\x58\x2d\x25\x30\x32\x58\x2d"
"\x25\x30\x32\x58\x2d\x25\x30\x32\x58\x2d\x25\x30\x32\x58",bb432[0 ],
bb432[1 ],bb432[2 ],bb432[3 ],bb432[4 ],bb432[5 ]);bb2 bb40;}bb41 bb106
bb1283=bb1513;bbb bb1867(){bbm(bb1283!=bb1513)bb2;
#ifdef UNDER_CE
bb1283=bb2603(bb599("\\\x69\x70\x73\x65\x63\x5f\x6c\x6f\x67\x2e\x74"
"\x78\x74"),bb2616|bb2592,bb2586|bb2650,0 ,bb2636,bb2637,0 );
#else
bb1283=0 ;
#endif
}bbb bb1878(){bbm(bb1283!=bb1513){
#ifdef UNDER_CE
bb2640(bb1283);
#endif
bb1283=bb1513;}}bbb bb157(bbh bbl*bb20,...){bb2530 bb197;bbq bb11;bbl
bb40[256 ];bbm(bb1283==bb1513)bb2;bb2483(bb197,bb20);bb11=bb2535(bb40,
bb12(bb40)-1 ,bb20,bb197);bb40[bb11]=0 ;
#ifdef UNDER_CE
bb2639(bb1283,bb40,bb11,&bb11,bb90);
#else
#ifdef _WIN32
#ifdef bb311
bb2590("\x25\x73",bb40);
#else
bb2646(bb40);bb324("\x25\x73",bb40);
#endif
#else
#ifdef bb311
bb586("\x25\x73",bb40);
...
#ifdef UNDER_CE
bbb bb2000(bb190 bbg){bb190 bb28=bbg;bbm(!bbg){bb157("\x28\x6e\x75"
"\x6c\x6c\x29\n");bb2;}bb107( *bb28){bbm(bb28!=bbg)bb157("\x2c\x20");
bb157("\x25\x6c\x73",bb28);bb28+=bb2601(bb28)+1 ;}bb157("\n");}
#endif
bbb bb2035(bbb*bb2524,bbq bb2523){bbl bb40[256 ];bbl*bb2208=(bbl* )bb2524
;bbl*bb2462=bb2208+bb2523;bbe bb1966=0 ;bbm(bb1283==bb1513)bb2;bb107(
...
"\x73",bb40);}bb157("\n");}bbb bb1964(bbb*bb6,bbq bb9){bbe bb1774=16 ;
bbq bbz;bbm(bb1283==bb1513)bb2;bb91(bbz=0 ;bbz<bb9;bbz+=bb1774){bbl
bb229[512 ];bbl*bbt=bb229;bbf*bbg=(bbf* )bb6+bbz;bbe bb75;bbt+=bb1316(
bbt,"\x25\x30\x34\x64",bbz);bb91(bb75=0 ;bb75<bb1774;bb75++){bbm(bbz+
bb75+1 <=bb9){bbe bb42=bbg[bb75];bbm(bb75>0 &&bb75%8 ==0 )bbt+=bb1316(bbt
,"\x20\x2d");bbt+=bb1316(bbt,"\x20\x25\x30\x32\x78",bb42);}bb54{bbm(
bb75>0 &&bb75%8 ==0 )bbt+=bb1316(bbt,"\x20\x20");bbt+=bb1316(bbt,"\x20"
"\x20\x20");}} *bbt++=' ';bb91(bb75=0 ;bb75<bb1774;bb75++){ *bbt++=bbz
+bb75<bb9?(bbg[bb75]<0x80 &&bb2505(bbg[bb75])?bbg[bb75]:'.'):' ';} *
bbt++='\n'; *bbt=0 ;bb157("\x25\x73",bb229);}}bbb bb1810(bbb*bb6,bbq
bb9){bbe bb1774=16 ;bbq bbz;bbm(bb1283==bb1513)bb2;bb91(bbz=0 ;bbz<bb9;
bbz+=bb1774){bb41 bbl bb229[512 ];bbl*bbt=bb229;bbf*bbg=(bbf* )bb6+bbz
;bbe bb75;bb91(bb75=0 ;bb75<bb1774;bb75++){bbm(bbz+bb75+1 <=bb9){bbe
bb42=bbg[bb75];bbt+=bb1316(bbt,"\x25\x30\x32\x78",bb42);}} *bbt=0 ;
bb157("\"\x25\x73\"\n",bb229);}}bbb bb1348(bbb*bb6,bbq bb9){bbe bb1774
=16 ;bbq bbz;bbm(bb1283==bb1513)bb2;bb91(bbz=0 ;bbz<bb9;bbz+=bb1774){
bb41 bbl bb229[512 ];bbl*bbt=bb229;bbf*bbg=(bbf* )bb6+bbz;bbe bb75;
bb91(bb75=0 ;bb75<bb1774;bb75++){bbm(bbz+bb75+1 <=bb9){bbe bb42=bbg[
bb75];bbt+=bb1316(bbt,"\\\x78\x25\x30\x32\x78",bb42);}} *bbt=0 ;bb157(""
"\"\x25\x73\"\n",bb229);}}bbb bb1896(){bb486*bbo=bb949.bb972->bb460;
bb157("\t" "\x62\x50\x47\x50\x6e\x65\x74\x45\x6e\x61\x62\x6c\x65\x64" ""
"\x3a\x25\x64\n",bbo->bb1122);bb157("\t" "\x46\x69\x72\x65\x77\x61"
"\x6c\x6c\x4c\x65\x76\x65\x6c" "\x3a\x25\x64\n",bbo->bb1071);}bbb
bb1747(){bbq bbz;bb33*bb937=bb949.bb972;bb157("\x6e\x75\x6d\x53\x41"
"\x73\x3a\x25\x64\n",bb937->bb534);bb91(bbz=0 ;bbz<bb937->bb534;bbz++){
bb199*bb28=&bb937->bb508[bbz].bb180;bbq bb75;bb157("\x73\x61\x5b\x25"
"\x64\x5d\n",bbz);bb157("\x20\x20" "\x69\x70\x41\x64\x64\x72\x65\x73"
"\x73" "\x3a\x25\x78\n",bb28->bb27);bb91(bb75=0 ;bb75<bb28->bb1118;
bb75++){bb157("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x69\x73\x52"
"\x61\x6e\x67\x65" "\x3a\x25\x78\n",bb75,bb28->bb919[bb75].bb1142);
bb157("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x69\x73\x45\x78\x63"
"\x6c\x75\x64\x69\x6e\x67" "\x3a\x25\x78\n",bb75,bb28->bb919[bb75].
bb1157);bb157("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x61\x64\x64"
"\x72\x53\x74\x61\x72\x74" "\x3a\x25\x78\n",bb75,bb28->bb919[bb75].
bb851);bb157("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x61\x64\x64\x72"
"\x4d\x61\x73\x6b\x4f\x72\x45\x6e\x64" "\x3a\x25\x78\n",bb75,bb28->
bb919[bb75].bb580);bb157("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x70"
"\x72\x6f\x74\x6f\x63\x6f\x6c" "\x3a\x25\x78\n",bb75,bb28->bb919[bb75
].bb102);bb157("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x70\x6f\x72"
"\x74" "\x3a\x25\x78\n",bb75,bb28->bb919[bb75].bb437);}bb157("\x20"
"\x20" "\x6e\x61\x74\x54\x72\x61\x76\x65\x72\x73\x61\x6c" "\x3a\x25"
"\x78\n",bb28->bb506);bb157("\x20\x20" "\x6e\x61\x74\x49\x50\x41\x64"
"\x64\x72\x65\x73\x73" "\x3a\x25\x78\n",bb28->bb1354);bb157("\x20\x20" ""
"\x6e\x62\x6f\x4e\x41\x54\x50\x6f\x72\x74" "\x3a\x25\x78\n",bb28->
bb1070);bb157("\x20\x20" "\x61\x73\x73\x69\x67\x6e\x65\x64\x49\x50" ""
"\x3a\x25\x78\n",bb28->bb553);bb157("\x20\x20" "\x61\x63\x74\x69\x76"
"\x65\x49\x6e" "\x3a\x25\x78\n",bb28->bb1332);bb157("\x20\x20" "\x61"
"\x63\x74\x69\x76\x65\x4f\x75\x74" "\x3a\x25\x78\n",bb28->bb1130);
bb157("\x20\x20\x69\x6e\x53\x50\x49\x3a\x25\x78\n", * (bb29)(bb28->
bb402[0 ]).bb954);bb157("\x20\x20\x6f\x75\x74\x53\x50\x49\x3a\x25\x78"
"\n", * (bb29)(bb28->bb402[0 ]).bb1213);bb157("\x20\x20" "\x74\x72\x61"
"\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x70\x72\x6f\x74\x6f\x63\x6f"
"\x6c" "\x3a\x25\x78\n",bb28->bb402[0 ].bb102);bb157("\x20\x20" "\x74"
"\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70"
"\x2e\x74\x2e\x63\x69\x70\x68\x65\x72" "\x3a\x25\x78\n",bb28->bb402[0
].bb316.bb308.bb45.bb154);bb157("\x20\x20" "\x74\x72\x61\x6e\x73\x66"
"\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e\x74\x2e\x61\x75"
"\x74\x68\x41\x74\x74\x72" "\x3a\x25\x78\n",bb28->bb402[0 ].bb316.
bb308.bb45.bb590);bb157("\x20\x20" "\x74\x72\x61\x6e\x73\x66\x6f\x72"
"\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e\x74\x2e\x6d\x6f\x64\x65" ""
"\x3a\x25\x78\n",bb28->bb402[0 ].bb316.bb308.bb45.bb57);bb157("\x20"
"\x20\x74\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65"
"\x73\x70\x2e" "\x69\x6e\x45\x53\x50\x4b\x65\x79" "\n");bb1348(bb28->
bb402[0 ].bb316.bb308.bb1219,bb12(bb28->bb402[0 ].bb316.bb308.bb1219));
...
"\n");bb1348(bb28->bb402[0 ].bb316.bb308.bb1229,bb12(bb28->bb402[0 ].
bb316.bb308.bb1229));bb157("\x20\x20\x74\x72\x61\x6e\x73\x66\x6f\x72"
"\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e" "\x69\x6e\x41\x75\x74"
"\x68\x4b\x65\x79" "\n");bb1348(bb28->bb402[0 ].bb316.bb308.bb552,bb12
(bb28->bb402[0 ].bb316.bb308.bb552));bb157("\x20\x20\x74\x72\x61\x6e"
"\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e" "\x6f"
"\x75\x74\x41\x75\x74\x68\x4b\x65\x79" "\n");bb1348(bb28->bb402[0 ].
bb316.bb308.bb559,bb12(bb28->bb402[0 ].bb316.bb308.bb559));bb157("\x20"
"\x20\x74\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65"
"\x73\x70\x2e" "\x65\x78\x70\x6c\x69\x63\x69\x74\x49\x56" "\n");
bb1348(bb28->bb402[0 ].bb316.bb308.bb1203,bb12(bb28->bb402[0 ].bb316.
bb308.bb1203));bb157("\x20\x20" "\x6c\x6f\x63\x61\x6c\x49\x50\x41\x64"
"\x64\x72\x65\x73\x73" "\x3a\x25\x78\n",bb28->bb595);bb157("\x20\x20"
"\x62\x69\x72\x74\x68\x54\x69\x6d\x65\x3a\x25\x78\n",bb937->bb508[bbz
].bb569);bb157("\x20\x20\x6c\x61\x73\x74\x53\x65\x6e\x64\x54\x69\x6d"
"\x65\x3a\x25\x78\n",bb937->bb508[bbz].bb1158);bb157("\x20\x20\x6c"
"\x61\x73\x74\x52\x65\x63\x76\x54\x69\x6d\x65\x3a\x25\x78\n",bb937->
bb508[bbz].bb1170);}}bbb bb1977(bb364*bb1920){bb364*bb2292=bb1920;bbl
...
"\x25\x78\n",bb2399(bb2292->bb1011,bbg),bb2399(bb2292->bb371,bbt),
bb196(bb2292->bb373));}bbb bb1578(bb326*bb28){bbl bbg[32 ],bbt[32 ];
...
"\n",bb28->bb958,bb196(bb28->bb370),bb196(bb28->bb895),bb196(bb28->
bb576),bb28->bb1004,bb28->bb247,bb1974(&bb28->bb310,bbg),bb1974(&bb28
->bb204,bbt));}bb41 bbb bb2470(bbe bbo,bbl bb40[16 ]){bbl*bb28=bb40;
...
bb1263(bb326*bb702,bb490*bb150){bbl bbg[32 ],bbt[32 ],bbo[16 ];bbm(!
bb150)bb150=(bb313)((bb1)bb702+bb702->bb958*4 );bb2470(bb150->bb170,
...
"\x64\x2c\x20\x75\x72\x67\x3a\x25\x64\n",bb1974(&bb702->bb310,bbg),
bb196(bb150->bb280),bb1974(&bb702->bb204,bbt),bb196(bb150->bb579),
bb2426(&bb150->bb546),bb2426(&bb150->bb924),(bb150->bb92&0xf0 )>>2 ,bbo
,bb196(bb150->bb158),bb196(bb150->bb1020));}bbb bb1485(bb326*bb702,
bb412*bb1612){bbl bbg[32 ],bbt[32 ];bbm(!bb1612)bb1612=(bb352)((bb1)bb702
+bb702->bb958*4 );bb157("\x75\x64\x70\x20\x73\x72\x63\x3a\x25\x73\x3a"
"\x25\x64\x2c\x20\x64\x65\x73\x74\x3a\x25\x73\x3a\x25\x64\n",bb1974(&
bb702->bb310,bbg),bb196(bb1612->bb280),bb1974(&bb702->bb204,bbt),
bb196(bb1612->bb425));}
