...
#define KEY_AKCPASS_FLAG			(KEY_CPASS_MTX_22 + 1)
#define KEY_CPASS_STATUS_CHK		(KEY_AKCPASS_FLAG + 1)
...
#define KEY_CFG_LCD_UP_DOWN_INT			(KEY_DMP_TAP_COUNT + 1)
...
/* Gesture Keys */
#define KEY_DMP_SH_TH_Y             (KEY_LCD_STATUS + 1)
